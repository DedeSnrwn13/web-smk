...
class CreateNilaiMulti11Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nilai_multi11', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('ppercetakan')->nullable();
            $table->integer('kpercetakan')->nullable();

            $table->integer('panimasi')->nullable();
            $table->integer('kanimasi')->nullable();
    ...
    {
        Schema::dropIfExists('nilai_multi11');
    }
}
