...
class CreateNilaiMutu10Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nilai_mutu10', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('pbiologi')->nullable();
            $table->integer('kbiologi')->nullable();

            $table->integer('ppenanganan')->nullable();
            $table->integer('kpenanganan')->nullable();

            $table->integer('ppengolahan')->nullable();
            $table->integer('kpengolahan')->nullable();

            $table->integer('ppertanian')->nullable();
            $table->integer('kpertanian')->nullable();

            $table->integer('ppengendalian')->nullable();
            $table->integer('kpengendalian')->nullable();
    ...
    {
        Schema::dropIfExists('nilai_mutu10');
    }
}
