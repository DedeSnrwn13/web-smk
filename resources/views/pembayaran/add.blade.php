...
@section('title')
    Dashboard | Tambah Jenis Pembayaran
@endsection
...
<div class="card shadow mt-4">
	<div class="card-header">
        <div class="row">
            <div class="col-md-10">
                <h3 class="panel-title"><i class="fas fa-user-plus"></i> Tambah Jenis Pembayaran</h3>
            </div>
        </div>
	</div>
	<div class="card-body">
		<div class="row">
            <div class="col-md-12">
                <form action="/admin/dashboard/pembayaran/store" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="no">NO <span class="text-danger">*</span></label>
                                <input name="no" type="number" class="form-control @error('no') is-invalid @enderror" value="{{ old('no') }}" id="no" placeholder="Input NO">
                                @error('no')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="jumlah" type="number" class="form-control @error('jumlah') is-invalid @enderror" value="{{ old('jumlah') }}" id="jumlah" placeholder="Input Jumlah">
                                @error('jumlah')
                                    <span class="invalid-feedback" role="alert">
