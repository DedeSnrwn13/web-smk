...
@section('title')
    Dashboard | Tambah Data Nilai Siswa 12 Multimedia
@endsection
...
@section('content')
    ...
    <div class="card shadow mt-4">
        <div class="card-header">
            <div class="row">
                <div class="col-md-10">
                    <h4 class="panel-title"><i class="fas fa-user-plus"></i> Tambah Nilai 12 Multimedia, kode kelas [12 E1 - 12 E2]</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('post.nilai.multi12') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" class="mapel">Bahasa Jepang <span class="text-danger">*</span></label>
                                    <div class="col-md-12 px-0">
                                        <input type="number" name="pjepang" id="pjepang" class="form-control" required placeholder="Input Nilai Pengetahuan">
                                        @error('pjepang')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('pjepang') }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 px-0 mt-2">
                                        <input type="number" name="kjepang" id="kjepang" class="form-control" required placeholder="Input Nilai Keterampilan">
                                        @error('kjepang')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('kjepang') }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" class="mapel"> Desain Media Interaktif <span class="text-danger">*</span></label>
                                    <div class="col-md-12 px-0">
                                        <input type="number" name="pinteraktif" id="pinteraktif" class="form-control" required placeholder="Input Nilai Pengetahuan">
                                        @error('pinteraktif')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('pinteraktif') }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 px-0 mt-2">
                                        <input type="number" name="kinteraktif" id="kinteraktif" class="form-control" required placeholder="Input Nilai Keterampilan">
                                        @error('kinteraktif')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('kinteraktif') }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="" class="mapel">Teknik Pengolahan Audio dan Video <span class="text-danger">*</span></label>
                                    <div class="col-md-12 px-0">
                                        <input type="number" name="paudio" id="paudio" class="form-control" required placeholder="Input Nilai Pengetahuan">
                                        @error('paudio')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('paudio') }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 px-0 mt-2">
                                        <input type="number" name="kaudio" id="kaudio" class="form-control" required placeholder="Input Nilai Keterampilan">
                                        @error('kaudio')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('kaudio') }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                </div>
