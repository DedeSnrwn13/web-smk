...
<a href="{{ route('cetak.rapot.id.mutu10', $rapot->id) }}" class="btn btn-success w-20 ml-3" target="_blank">
    Cetak
</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" class="text-center">4</th>
                                <td>Biologi</td>
                                <td class="text-center">{{ $rapot->pbiologi }}</td>
                                <td class="text-center">{{ $rapot->kbiologi }}</td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row" class="text-center">1</th>
                                <td>Dasar Penanganan Bahan Hasil Pertanian</td>
                                <td class="text-center">{{ $rapot->ppenanganan }}</td>
                                <td class="text-center">{{ $rapot->kpenanganan }}</td>
                            </tr>
                            <tr>
                                <th scope="row" class="text-center">2</th>
                                <td>Dasar Proses Pengolahan Hasil</td>
                                <td class="text-center">{{ $rapot->ppengolahan }}</td>
                                <td class="text-center">{{ $rapot->kpengolahan }}</td>
                            </tr>
                            <tr>
                                <th scope="row" class="text-center">3</th>
                                <td>Pertanian</td>
                            ...
                            <tr>
                                <th scope="row" class="text-center">4</th>
                                <td>Dasar Pengendalian Mutu Hasil Pertanian</td>
                                <td class="text-center">{{ $rapot->ppengendalian }}</td>
                                <td class="text-center">{{ $rapot->kpengendalian }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
