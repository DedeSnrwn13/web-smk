...
<div class="card shadow mt-4">
	...
	<div class="card-body">
		<div class="row">
            <div class="col-md-12">
                <form action="{{ route('update.nilai.mutu11', $nilai->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="pbiologis" id="pbiologis" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('pbiologis') ?? $nilai->pbiologis }}">
                                    @error('pbiologis')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kbiologis" id="kbiologis" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kbiologis') ?? $nilai->kbiologis }}">
                                    @error('kbiologis')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="pinstrumental" id="pinstrumental" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('pinstrumental') ?? $nilai->pinstrumental }}">
                                    @error('pinstrumental')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kinstrumental" id="kinstrumental" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kinstrumental') ?? $nilai->kinstrumental }}">
                                    @error('kinstrumental')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="ppengujian" id="ppengujian" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('ppengujian') ?? $nilai->ppengujian }}">
                                    @error('ppengujian')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kpengujian" id="kpengujian" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kpengujian') ?? $nilai->kpengujian }}">
                                    @error('kpengujian')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="pmekanis" id="pmekanis" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('pmekanis') ?? $nilai->pmekanis }}">
                                    @error('pmekanis')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kmekanis" id="kmekanis" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kmekanis') ?? $nilai->kmekanis }}">
                                    @error('kmekanis')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="pkeamanan" id="pkeamanan" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('pkeamanan') ?? $nilai->pkeamanan }}">
                                    @error('pkeamanan')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kkeamanan" id="kkeamanan" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kkeamanan') ?? $nilai->kkeamanan }}">
                                    @error('kkeamanan')
                                        <span class="invalid-feedback" role="alert">
