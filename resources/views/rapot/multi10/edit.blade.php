...
<div class="card shadow mt-4">
	...
	<div class="card-body">
		<div class="row">
            <div class="col-md-12">
                <form action="{{ route('update.nilai.multi10', $nilai->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="psiskom" id="psiskom" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('psiskom') ?? $nilai->psiskom }}">
                                    @error('psiskom')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="ksiskom" id="ksiskom" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('ksiskom') ?? $nilai->ksiskom }}">
                                    @error('ksiskom')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="pjaringan" id="pjaringan" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('pjaringan') ?? $nilai->pjaringan }}">
                                    @error('pjaringan')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kjaringan" id="kjaringan" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kjaringan') ?? $nilai->kjaringan }}">
                                    @error('kjaringan')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="ppemrograman" id="ppemrograman" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('ppemrograman') ?? $nilai->ppemrograman }}">
                                    @error('ppemrograman')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kpemrograman" id="kpemrograman" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kpemrograman') ?? $nilai->kpemrograman }}">
                                    @error('kpemrograman')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 px-0">
                                    <input type="number" name="pdesain" id="pdesain" class="form-control" required placeholder="Input Nilai Pengetahuan" value="{{ old('pdesain') ?? $nilai->pdesain }}">
                                    @error('pdesain')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-12 px-0 mt-2">
                                    <input type="number" name="kdesain" id="kdesain" class="form-control" required placeholder="Input Nilai Keterampilan" value="{{ old('kdesain') ?? $nilai->kdesain }}">
                                    @error('kdesain')
                                        <span class="invalid-feedback" role="alert">
