...
<a href="{{ route('cetak.rapot.id.multi12', $rapot->id) }}" class="btn btn-success w-20 ml-3" target="_blank">
    Cetak
</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Bahasa Jepang</td>
                                <td class="text-center">{{ $rapot->pjepang }}</td>
                                <td class="text-center">{{ $rapot->kjepang }}</td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row" class="text-center">2</th>
                                <td>Desain Media Interaktif</td>
                                <td class="text-center">{{ $rapot->pinteraktif }}</td>
                                <td class="text-center">{{ $rapot->kinteraktif }}</td>
                            </tr>
                            <tr>
                                <th scope="row" class="text-center">3</th>
                                <td>Teknik Pengolahan Audio dan Video</td>
                                <td class="text-center">{{ $rapot->paudio }}</td>
                                <td class="text-center">{{ $rapot->kaudio }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
