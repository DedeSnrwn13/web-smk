...
<!-- Section Content -->
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('materi.create') }}" class="btn btn-primary mb-3">
                        + Tambah Materi Baru
                    </a>
                            ...
                            <tbody>
                                ...
                                @foreach ($materi as $mat)
                                    <tr>
                                        ...
                                        <td style="width: 13%;">
                                            <a href="materi/{{ $mat->id }}/edit" class="btn btn-sm btn-warning float-left">Edit</a>
                                            <form action="/materi/{{ $mat->id }}/destroy" method="POST">
                                                @csrf
                                                @method('DELETE')
